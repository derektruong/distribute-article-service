...
func SportHandler(cl *Client) fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		results, err := cl.FetchThings("others", "", page,"https://newsapi.org/v2/top-headlines?country=us&category=sports&page=%s&pageSize=%d&apiKey=%s&sortBy=popularity&language=en")
		// fmt.Println(results)
